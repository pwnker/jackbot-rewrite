...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await interaction.reply({content:`Unbanned **${user.username}#${user.discriminator}**`, ephemeral: true});

        embed = new MessageEmbed()
            .setColor("AQUA")
            .setTitle("Discord User Unanned")
            .setThumbnail(user.displayAvatarURL({dynamic: true}))
            .setFooter({text:`Unbanned by ${interaction.user.username} | ${interaction.user.id}`})
            .addFields(
